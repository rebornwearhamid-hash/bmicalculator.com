          ...
          <section id="about" className="mt-16 max-w-4xl mx-auto">
            <article className="bg-white rounded-2xl shadow-lg p-8 sm:p-12">
              ...
              <div className="prose prose-lg max-w-none text-gray-600 space-y-4">
                ...
                <p>
                  BMI is a useful measurement for most people over 18 years old. However, it's only an estimate and doesn't account for factors like muscle mass, bone density, overall body composition, age, or sex.
                </p>
